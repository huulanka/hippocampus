...
- **[Operations](operations.md)** — Backup, a restore that has actually been run, deploying to a NAS
...
- **[Product scope](product.md)** — What the system is for, and the principles it is held to
- **[Roadmap](roadmap.md)** — Phases, each with a criterion for going on or stopping, and what is still open
- **[Memory model](memory-model.md)** — The six concepts the system knows, and the ones it refuses to
- **[Interface](design.md)** — Where every function lives, and why it looks the way it does
...
- **[0004](adr/0004-audio-is-the-original.md)** — The audio is the original, the transcript an interpretation
- **[0005](adr/0005-corrections-and-redactions.md)** — Corrections and redactions without touching the original
- **[0006](adr/0006-echo-before-graph.md)** — Echo before graph
