...
| P11 | Kein Morning Brief, keine Push-Benachrichtigungen — mit **einer** Ausnahme: die Wochenrückschau meldet sich einmal pro Woche, zu Tag und Uhrzeit, die der Nutzer selbst setzt, abschaltbar | Jede Benachrichtigung ist eine Gewohnheit, die extra aufgebaut werden muss. Die Ausnahme (vom Nutzer am 23.09.2026 gewählt) hängt an einem Termin, den er ohnehin hat, statt einen neuen zu erfinden, und kommt nie öfter als einmal pro Woche. Sie sagt nichts über den Inhalt der Notizen: Lesen ist hinter der Sperre, ein Mitteilungsbanner nicht |
